                                        ...
                                        <td class="forumRow">
                                            <table cellSpacing="1" cellPadding="3">
                                                ...
                                                <tr>
                                                    ...
                                                    <td vAlign="top" align="left"><input name="txtTitle" type="text" size="55" id="txtTitle" autocomplete="off" value="{{ $post->title }}" /></td>
                                                    @error('title')
                                                ...
                                                <tr>
                                                    ...
                                                    <td vAlign="top" align="left"><textarea name="txtBody" rows="20" cols="90" id="txtBody">{{ $post->body }}</textarea>
                                                    </td>
                                                    <td vAlign="top">&nbsp;</td>
                                                    @error('body')
                                                    <td><span id="ctl00_cphRoblox_Createeditpost1_PostForm_RequiredFieldValidator1" class="validationWarningSmall" style="color:Red;">{{ $message }}</span></td>
                                                ...
                                                <tr>
                                                    <td vAlign="top" align="right" colSpan="2">
                                                        <input type="submit" name="ctl00$cphRoblox$Createeditpost1$PostForm$PostButton" value=" Save " onclick="dopost()" id="ctl00_cphRoblox_Createeditpost1_PostForm_PostButton" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
...
<form id="PostForm" action="{{ route('forum.doeditthread', $post->id) }}" method="post">
    @csrf
